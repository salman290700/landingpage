    ...
    <section className="flexCenter flex-col">
      ...
      max-container w-full pb-24'>
        <Image
          ...
          height={50}
        />
        <p className='uppcercase regular-18 -mt-1 mb-3 text-green-50'>
          WE ARE HERE FOR YOU
        </p>
        ...
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          ...
          <p className="text-gray-30 regular-16 xl:max-w-[520px]">
            Only with hilink application you will no longer get
            loat and get lost again, because we already support offline
