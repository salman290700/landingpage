...
const CampSite = ({backgroundImage, title, subtitle, peopleJoined}: CampSiteProps) => {
  return (
    <div className={`mx-6 h-full w-full min-w-[1100px] ${backgroundImage}
...
const Camp = () => {
  return (
    <>
      ...
      flex flex-col py-10 lg:mb-10 lg:py-10 xl:mb-20'>      
        <div className='hide-scrollbar flex h-[340px] w-full items-start
        justify-start gap-8 overflow-x-auto lg:h-[520px] xl:h-[640px]'>
          <CampSite
        ...
        <div className="flexEnd mt-10 px-6 lg:-mt-40 lg:mr-6">
          <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-6 xl:py-20 relative w-full
