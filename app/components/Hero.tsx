    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      <div className="realtive z-20 flex flex-1 flex-col xl:w-1/2">
        <Image
          ...
          width={50}
          height={50}
          className='relative left-[-5px] top-[-30px] w-10 lg:w-[-50px]'
        />
        ...
        <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>
          ...
          We can help you on adventure around the world in just one
          app.
        </p>
          ...
          <div className='flex flex-col'>
            ...
            <div className="flexBetween">
              <div className="flex-flex-col">
                ...
                <p className='bold-20 text-white'>173.3 mil</p>
              </div>
